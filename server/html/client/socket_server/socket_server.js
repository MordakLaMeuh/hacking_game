	...
	this.post = function(json_msg) {
		...
		default:
			...
			if (lvlValidation.checkCommand(cmdList, input[0]) == false) {
				let obj = new Object();
				obj.string = "This command does not exist on the system. Type \"help\" to get a list of usefull commands and \"hint\" to get some hints to reach the next level";
				send({"tty": obj});
				return ;
			}
			...
			case "exit":
				...
				break;
			default :
				output = "This command does not exist on the system. Type \"help\" to get a list of usefull commands and \"hint\" to get some hints to reach the next level";
				break;
			}
			break;
		}
